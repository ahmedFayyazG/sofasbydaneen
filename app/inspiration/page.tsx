...
const stories = [
  { eyebrow: "Seasonal edit", title: "The Art of Living Well", copy: "Soft silhouettes, tactile fabrics and considered colour palettes for rooms designed around everyday comfort.", image: "/products/chaise-sofa/01-slate-grey-velvet/studio/daneen-chaise-sofa-slate-grey-velvet-studio-01.jpg", href: "/shop" },
  { eyebrow: "Most loved", title: "The Daneen Bestsellers", copy: "Discover the shapes our customers return to: generous corners, elegant chaise sofas and beautifully balanced modular seating.", image: "/products/modular-corner-sofa/01-beige/studio/daneen-modular-corner-sofa-beige-studio-01.jpg", href: "/shop" },
  { eyebrow: "Style edit", title: "Quiet Luxury", copy: "Warm neutrals, deep textures and sculptural forms create an interior that feels calm, confident and collected.", image: "/products/chaise-sofa/02-oatmeal-linen/studio/daneen-chaise-sofa-oatmeal-linen-studio-01.jpg", href: "/shop?color=ivory" },
];
  ...
  return <div className="inspiration-page">
    ...
    <main>
      ...
      <section className="insp-section">
        ...
        <div className="insp-grid">
          {stories.slice(1).map((story) => <article className="insp-card" key={story.title}>
            <Link href={story.href} className="insp-card-image"><img src={story.image} alt="" /></Link>
      ...
      <section className="insp-fabric">
        ...
        <img src="/products/chaise-sofa/01-slate-grey-velvet/detail/daneen-chaise-sofa-slate-grey-velvet-detail-01.jpg" alt="Close detail of sofa upholstery" />
      </section>
      ...
      <section className="insp-realhomes">
        ...
        <div className="insp-realhomes-images"><img src="/products/modular-corner-sofa/01-beige/studio/daneen-modular-corner-sofa-beige-studio-01.jpg" alt="Modular sofa"/><img src="/products/chaise-sofa/01-slate-grey-velvet/studio/daneen-chaise-sofa-slate-grey-velvet-studio-01.jpg" alt="Chaise sofa"/></div>
      </section>
    </main>
  </div>;
}

...
export const metadata: Metadata = {
  ...
  description: "Browse the Sofas By Daneen collection — corner sofas, chaise sofas, U-shape sectionals, modular seating and our Chesterfield, each handcrafted in France in couture fabrics.",
      ...
      <div id="top">
        ...
        <main id="main-content">
          <section className="cats-hero">
            ...
            <h1>OUR SOFAS</h1>
            <p className="soft-copy">Five silhouettes, each handcrafted in our Lille workshop and finished by hand in the fabric of your choosing.</p>
          </section>

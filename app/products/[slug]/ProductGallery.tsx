...
export default function ProductGallery({ product, initialFabricCode }: { product: Product; initialFabricCode?: string }) {
  ...
  return <>
    ...
    <section className="dfs-pdp-shell">
      ...
      <aside className="dfs-buy-column dfs-desktop-buy"><div className="dfs-desktop-summer-sale">SUMMER SALE</div><div className="dfs-product-heading"><h1>{product.name.replace(/^The\s+/i, "")}</h1><p>{product.tagline}</p><div className="dfs-stars">★★★★★ <span>4.9 · 32 reviews</span></div></div><Options /><PurchaseBlock /></aside>
    </section>
